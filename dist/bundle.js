...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__index_css__ = __webpack_require__(463);
...
function graph(data) {
	...
	h=500,
	padding=60,
	parseTime = __WEBPACK_IMPORTED_MODULE_0_d3__["j" /* timeParse */]("%M:%S");
	dataset.forEach((d)=>d.Time = parseTime(d.Time));

	const div = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* select */]("main").append("div")
		.attr("class","tooltip")
		.style("opacity",0);

	const xScale = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* scaleTime */]()
						.domain([__WEBPACK_IMPORTED_MODULE_0_d3__["e" /* min */](dataset,(d)=>d.Time),__WEBPACK_IMPORTED_MODULE_0_d3__["d" /* max */](dataset,(d)=>d.Time)])
						.range([padding,w-padding]);

	const yScale = __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* scaleLinear */]()
						.domain([1,35])
						.range([h-padding,padding]);

	const svg = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* select */]("main")
					.append("svg")
					.attr("width", w)
					.attr("height", h)
	...
	svg.selectAll("circle")
		...
		.attr("r", 5)
		.on("mouseover", (d)=>{
			let parseTime = __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* timeFormat */]("%M:%S")
	...
	const xAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["a" /* axisBottom */](xScale).tickFormat(__WEBPACK_IMPORTED_MODULE_0_d3__["i" /* timeFormat */]("%M:%S"));
	svg.append("g")
	...
	const yAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* axisLeft */](yScale);
	svg.append("g")
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "j", function() { return __WEBPACK_IMPORTED_MODULE_26_d3_time_format__["b"]; });
...
var update = __webpack_require__(466)(content, options);
...
exports = module.exports = __webpack_require__(465)(undefined);
// imports


// module
exports.push([module.i, "html, body {\n  height: 100%;\n  margin: 0; }\n\nheader, footer {\n  background: #ab0b2e;\n  width: 100%; }\n\nheader {\n  padding: 1em; }\n\nfooter {\n  padding: 0.5em;\n  text-align: center;\n  color: white; }\n  footer a {\n    color: white; }\n\nmain {\n  background: #0a7b8d; }\n  main svg {\n    border-radius: 5px;\n    margin: 1% 5% 1% 5%; }\n\ndiv.tooltip {\n  position: absolute;\n  border: 3px solid #c36024;\n  border-radius: 5px;\n  background: #de8641;\n  pointer-events: none;\n  padding: 0.25em; }\n", ""]);
...
var	fixUrls = __webpack_require__(467);
